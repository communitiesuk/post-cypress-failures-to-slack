...
const fsNode = __nccwpck_require__(7147);
...
function getStat(path, fs = fsNode) {
    try {
...
function _walkSync(baseDir, options, _relativePath, visited) {
    var _a;
    const fs = (_a = options.fs) !== null && _a !== void 0 ? _a : fsNode;
